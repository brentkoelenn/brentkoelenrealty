...
export default async function SearchPage({ searchParams }: SearchPageProps) {
  ...
  const results = await listingService.searchListings(params);
    ...
    <div className="py-12 sm:py-16">
      <Container>
        ...
        <p className="mt-3 text-stone max-w-2xl">
          Browse sample listings across Hanover, Walkerton, Owen Sound, Kincardine, Port Elgin,
          Southampton, Sauble Beach and rural Grey Bruce &amp; Bruce County.
        </p>
