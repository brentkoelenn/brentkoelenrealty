...
export default async function FarmsPage() {
  const listings = await listingService.getListingsByPropertyTypes(["Farm", "Hobby Farm", "Vacant Land"]);
  ...
  return (
    <div className="py-14 sm:py-20">
      <Container>
        ...
        <div className="mt-14">
          <SectionHeading eyebrow="Sample Listings" title="Farm & Acreage Properties" />
