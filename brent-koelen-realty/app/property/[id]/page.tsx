...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description: `${listing.headline} — ${listing.bedrooms} bed, ${listing.bathrooms} bath ${listing.propertyType.toLowerCase()} in ${listing.city}, Ontario. Sample listing.`,
  };
}
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-8 flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
              <div>
                ...
                <p className="text-sm text-mist mt-1">MLS® {listing.mlsNumber} (sample)</p>
              </div>
            </div>
