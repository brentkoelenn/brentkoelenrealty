  ...
  return (
    <footer className="bg-ink text-white mt-24">
      ...
      <div className="border-t border-white/10">
        <Container className="py-7 flex flex-wrap items-center gap-4">
          <div className="bg-white rounded-sm px-4 py-2.5 flex items-center">
            <Image
              src="/images/brand/kirstine-ellis-group-logo.png"
              alt="The Kirstine-Ellis Group"
              width={126}
              height={44}
