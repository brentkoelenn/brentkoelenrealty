...
export interface Listing {
  ...
  mlsNumber: string; // real MLS® number once DDF is connected; SAMPLE-xxxxx before that
  isSample: boolean; // true for demo data, false for real DDF listings — UI uses this to show/hide the "SAMPLE LISTING" badge
